        ...
        <div class="container">
            <div class="card">
                ...
                <div style="display: flex; gap: 10px; flex-wrap: wrap; margin-top: 15px;">
                    <a href="menu.php" class="btn btn-secondary<?php echo !isset($_GET['category']) ? ' active' : ''; ?>">Tất cả</a>
                    <?php foreach ($categories as $cat): ?>
                    <a href="menu.php?category=<?php echo urlencode($cat['ma_danh_muc']); ?>" 
            ...
            <div class="card">
                ...
                <div class="product-grid">
                    ...
                    <div class="product-item">
                        <a href="product_detail.php?id=<?php echo urlencode($product['ma_sp']); ?>" style="text-decoration:none; color:inherit;">
                        ...
                        <p style="margin-top: 10px;"><a href="product_detail.php?id=<?php echo urlencode($product['ma_sp']); ?>" class="btn btn-small">Xem chi tiết</a></p>
                    </div>
                    <?php endforeach; ?>
                </div>
                <?php endif; ?>
